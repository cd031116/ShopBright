package com.zhl.huiqu.recyclebase;
...
public class ViewHolder extends RecyclerView.ViewHolder
{
    ...
    {
        ImageView view = getView(viewId);
        view.setLayoutParams(new RelativeLayout.LayoutParams(weith,hight));
        return this;
    }
    ...
    public ViewHolder setSesect(int viewId, boolean checked)
    {
        View view = getView(viewId);
