...
public class MonthAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements View.OnClickListener {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        if (TextUtils.isEmpty(dataList.get(position).date)) {
            ...
            Log.e("ttt", obtaindata(dataList.get(position).million / 1000 + "").getMonth() + "---" + month + ";\t" + obtaindata(dataList.get(position).million / 1000 + "").getDate() + "---" + day);
            ...
            if (dateString.equals(dataList.get(position).date)) {
                if (dataList.get(position).isToday) {
                    ((MyViewHolder) holder).bg.setBackgroundColor(ContextCompat.getColor(mContext, R.color.color_ffffff));
                    ((MyViewHolder) holder).recommendtTitle.setTextColor(ContextCompat.getColor(mContext, R.color.color_28d19d));
                    ((MyViewHolder) holder).recommendPrice.setTextColor(ContextCompat.getColor(mContext, R.color.color_28d19d));
                } else {
